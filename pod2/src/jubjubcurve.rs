...
use crate::jubjubfield::{CircuitBuilderJubjubField, JubjubFieldTarget};
...
pub trait CircuitBuilderJubjubCurve {
    ...
    fn add_jubjub_curve(&mut self, p: &JubjubCurveTarget, q: &JubjubCurveTarget) 
        -> JubjubCurveTarget;

    fn mul_scalar(&mut self, p: &JubjubCurveTarget, s: &BigUintTarget);
}
...
mod tests {
    ...
    use crate::biguint::{BigUintTarget, CircuitBuilderBiguint};
    use crate::jubjubcurve::{CircuitBuilderJubjubCurve, JubjubCurveTarget};
    use crate::jubjubfield::{CircuitBuilderJubjubField, JubjubFieldTarget};
