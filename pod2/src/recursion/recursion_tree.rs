/*
 ...
 In other words, each p_i is either
    - InnerCircuit logic
    - recursive plonky2 proof verification (proof that verifies previous proof)
...
mod tests {
    ...
    fn test_recursion_opt<const N: usize>() -> Result<()> {
        set_log();
        println!("\n--------------------------------------------------");
        println!("\n--------------------------------------------------");
        println!(
